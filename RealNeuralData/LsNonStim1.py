...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:21:56 2021
...
pre = np.load('PreLargeScaleNonStim_1.npy')
post = np.load('PostLargeScaleNonStim_1.npy')
...
np.save('LargeScaleInvNonStim_1',samples)