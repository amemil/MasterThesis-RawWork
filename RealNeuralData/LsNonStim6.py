...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:22:02 2021
...
pre = np.load('PreLargeScaleNonStim_6.npy')
post = np.load('PostLargeScaleNonStim_6.npy')
...
np.save('LargeScaleInvNonStim_6',samples)