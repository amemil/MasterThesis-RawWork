...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 29 16:47:19 2021
...
pre = np.load('PreNonStim20sec_cand2.npy')
post = np.load('PostNonStim20sec_cand2.npy')
...
np.save('SampleNonstim20sec_cand2',sample)