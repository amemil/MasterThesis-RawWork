...
# -*- coding: utf-8 -*-
"""
Created on Tue May 25 17:14:39 2021
...
for i in range(21,31):
    pre = np.load('Pre20secLsStim_'+str(i+1)+'.npy')
    post = np.load('Post20secLsStim_'+str(i+1)+'.npy')
...
np.save('StimSamples20sec21to31',samples)