...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:21:57 2021
...
pre = np.load('PreLargeScaleNonStim_2.npy')
post = np.load('PostLargeScaleNonStim_2.npy')
...
np.save('LargeScaleInvInvNonStim_2',samples)