...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:22:05 2021
...
pre = np.load('PreLargeScaleNonStim_9.npy')
post = np.load('PostLargeScaleNonStim_9.npy')
...
np.save('LargeScaleInvNonStim_9',samples)