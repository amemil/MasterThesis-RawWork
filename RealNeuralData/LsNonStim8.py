...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:22:04 2021
...
pre = np.load('PreLargeScaleNonStim_8.npy')
post = np.load('PostLargeScaleNonStim_8.npy')
...
np.save('LargeScaleInvNonStim_8',samples)