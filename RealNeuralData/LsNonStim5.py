...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:22:01 2021
...
pre = np.load('PreLargeScaleNonStim_5.npy')
post = np.load('PostLargeScaleNonStim_5.npy')
...
np.save('LargeScaleInvNonStim_5',samples)