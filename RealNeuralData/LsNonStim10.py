...
# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:22:07 2021
...
pre = np.load('PreLargeScaleNonStim_10.npy')
post = np.load('PostLargeScaleNonStim_10.npy')
...
np.save('LargeScaleInvNonStim_10',samples)