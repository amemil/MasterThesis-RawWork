...
library(RcppCNPy)
library(EnvStats)
Stim = npyLoad("StimCand1Sample.npy")
NonStim = npyLoad("NonstimCand1Sample.npy")
...
npySave("MapAStimCand1.npy",MapAStim)
npySave("MapTauStimCand1.npy",MapTauStim)
npySave("MapANonStimCand1.npy",MapANonStim)
npySave("MapTauNonStimCand1.npy",MapTauNonStim)
```
