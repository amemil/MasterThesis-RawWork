...
if __name__ == "__main__":  
    ...
    np.save('1msbase3',theta_1ms_baseline)
    np.save('1msfreq3',theta_1ms_freq)
    np.save('5msbase3',theta_5ms_baseline)
    np.save('5msfreq3',theta_5ms_freq)
    np.save('prebase3',s1)
    np.save('postbase3',s2)
