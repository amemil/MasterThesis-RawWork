...
# -*- coding: utf-8 -*-
"""
Created on Mon May 31 17:05:04 2021
...
for i in range(10):
    ...
    for j in range(len(w0s)):
        data = ut.SimulatedData(Ap=0.005, tau=0.02, std=0.0001,b1=-3.1, b2=-3.1, w0=w0s[j],sec = 1, binsize = 1/500.0,freq = 20)
...
np.save('Samples1sec20Hz11to20',samples)