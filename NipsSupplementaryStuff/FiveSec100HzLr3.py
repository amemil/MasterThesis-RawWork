...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 18:31:44 2021
...
for i in range(20):
    ...
    for j in range(len(w0s)):
        data = ut.SimulatedData(Ap=0.005, tau=0.06, std=0.0001,b1=-3.1, b2=-3.1, w0=w0s[j],sec = 5, binsize = 1/500.0,freq = 100)
...
np.save('Samples5sec100Hz1to20_Lr3',samples)