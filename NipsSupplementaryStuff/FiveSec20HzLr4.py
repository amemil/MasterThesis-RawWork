...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 18:31:47 2021
...
for i in range(20):
    ...
    for j in range(len(w0s)):
        data = ut.SimulatedData(Ap=0.02, tau=0.02, std=0.0001,b1=-3.1, b2=-3.1, w0=w0s[j],sec = 5, binsize = 1/500.0,freq = 20)
...
np.save('Samples5sec20Hz1to20_Lr4',samples)