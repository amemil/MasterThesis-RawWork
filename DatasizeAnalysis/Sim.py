...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 16:36:42 2021
...
#Simultaneous, 2ms binsize, different datasizes
...
for i in range(len(datasizes)):
    ...
    Simest = inference.standardMH() 
    samples.append(Simest)
    
np.save('SimSamples',samples)