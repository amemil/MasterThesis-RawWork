...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 25 14:58:06 2021
...
for i in range(len(datasizes)):
    ...
    while (w0est1 < 0.97 or w0est1 > 1.03):
        data = ut.SimulatedData(Ap=0.005, tau=0.02, std=0.003,b1=-2, b2=-2, w0=1.0,sec = datasizes[i], binsize = 1/200.0)
        data.create_data()
...
np.save('SigmaSamples0.003True',samples)