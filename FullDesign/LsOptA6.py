...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:34 2021
...
np.save('WHestmimates_A6',means)
np.save('WHentropies_A6',entrs)
np.save('WHoptfrqs_A6',optms)
np.save('WHmutinfs_A6',mutinfs)
np.save('WHw_A6',W)
np.save('WHposts_A6',posts)