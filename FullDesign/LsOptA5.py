...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:32 2021
...
np.save('WHestmimates_A5',means)
np.save('WHentropies_A5',entrs)
np.save('WHoptfrqs_A5',optms)
np.save('WHmutinfs_A5',mutinfs)
np.save('WHw_A5',W)
np.save('WHposts_A5',posts)