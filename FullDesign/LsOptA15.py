...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:55:12 2021
...
np.save('WHestmimatesA_15',means)
np.save('WHentropiesA_15',entrs)
np.save('WHoptfrqsA_15',optms)
np.save('WHmutinfsA_15',mutinfs)
np.save('WHwA_15',W)
np.save('WHpostsA_15',posts)