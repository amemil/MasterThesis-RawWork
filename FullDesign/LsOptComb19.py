...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 18:05:44 2021
...
np.save('WHestmimatesComb_19',means)
np.save('WHentropiesComb_19',entrs)
np.save('WHoptfrqsComb_19',optms)
np.save('WHmutinfsComb_19',mutinfs)
np.save('WHwComb_19',W)
np.save('WHpostsComb_19',posts)
