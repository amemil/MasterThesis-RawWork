...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 18:05:40 2021
...
np.save('WHestmimatesComb_16',means)
np.save('WHentropiesComb_16',entrs)
np.save('WHoptfrqsComb_16',optms)
np.save('WHmutinfsComb_16',mutinfs)
np.save('WHwComb_16',W)
np.save('WHpostsComb_16',posts)
