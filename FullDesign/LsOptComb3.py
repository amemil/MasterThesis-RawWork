...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:26 2021
...
np.save('WHestmimatesComb_3',means)
np.save('WHentropiesComb_3',entrs)
np.save('WHoptfrqsComb_3',optms)
np.save('WHmutinfsComb_3',mutinfs)
np.save('WHwComb_3',W)
np.save('WHpostsComb_3',posts)
