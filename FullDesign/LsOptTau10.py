...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:07 2021
...
np.save('WHestmimatesTau_10',means)
np.save('WHentropiesTau_10',entrs)
np.save('WHoptfrqsTau_10',optms)
np.save('WHmutinfsTau_10',mutinfs)
np.save('WHwTau_10',W)
np.save('WHpostsTau_10',posts)