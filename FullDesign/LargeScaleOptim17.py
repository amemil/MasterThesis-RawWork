...
np.save('WHestmimatesNewGrid_17',means)
np.save('WHentropiesNewGrid_17',entrs)
np.save('WHoptfrqsNewGrid_17',optms)
np.save('WHmutinfsNewGrid_17',mutinfs)
np.save('WHwNewGrid_17',W)
np.save('WHpostsNewGrid_17',posts)
