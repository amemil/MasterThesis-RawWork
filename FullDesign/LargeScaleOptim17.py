...
np.save('WHestmimatesDalesLaw_17',means)
np.save('WHentropiesDalesLaw_17',entrs)
np.save('WHoptfrqsDalesLaw_17',optms)
np.save('WHmutinfsDalesLaw_17',mutinfs)
np.save('WHwDalesLaw_17',W)
np.save('WHpostsDalesLaw_17',posts)
