...
np.save('WHestmimatesNewGrid_3',means)
np.save('WHentropiesNewGrid_3',entrs)
np.save('WHoptfrqsNewGrid_3',optms)
np.save('WHmutinfsNewGrid_3',mutinfs)
np.save('WHwNewGrid_3',W)
np.save('WHpostsNewGrid_3',posts)
