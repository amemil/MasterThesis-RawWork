...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:31 2021
...
np.save('WHestmimates_A4',means)
np.save('WHentropies_A4',entrs)
np.save('WHoptfrqs_A4',optms)
np.save('WHmutinfs_A4',mutinfs)
np.save('WHw_A4',W)
np.save('WHposts_A4',posts)