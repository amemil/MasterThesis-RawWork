...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 19:42:00 2021
...
np.save('EstimatesWholeOptimTrueValuesInOptim',means)
np.save('EntropiesWholeOptimTrueValuesInOptim',entrs)
np.save('OptFrequenciesWholeOptimTrueValuesInOptim',optms)
