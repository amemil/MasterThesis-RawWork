...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:29 2021
...
np.save('WHestmimatesComb_5',means)
np.save('WHentropiesComb_5',entrs)
np.save('WHoptfrqsComb_5',optms)
np.save('WHmutinfsComb_5',mutinfs)
np.save('WHwComb_5',W)
np.save('WHpostsComb_5',posts)
