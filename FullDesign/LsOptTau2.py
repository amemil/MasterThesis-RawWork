...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:01:57 2021
...
np.save('WHestmimatesTau_2',means)
np.save('WHentropiesTau_2',entrs)
np.save('WHoptfrqsTau_2',optms)
np.save('WHmutinfsTau_2',mutinfs)
np.save('WHwTau_2',W)
np.save('WHpostsTau_2',posts)