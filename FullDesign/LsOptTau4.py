...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:00 2021
...
np.save('WHestmimatesTau_4',means)
np.save('WHentropiesTau_4',entrs)
np.save('WHoptfrqsTau_4',optms)
np.save('WHmutinfsTau_4',mutinfs)
np.save('WHwTau_4',W)
np.save('WHpostsTau_4',posts)
