...
np.save('WHestmimatesDalesLaw_8',means)
np.save('WHentropiesDalesLaw_8',entrs)
np.save('WHoptfrqsDalesLaw_8',optms)
np.save('WHmutinfsDalesLaw_8',mutinfs)
np.save('WHwDalesLaw_8',W)
np.save('WHpostsDalesLaw_8',posts)
