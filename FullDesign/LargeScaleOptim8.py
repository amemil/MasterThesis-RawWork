...
np.save('WHestmimatesNewGrid_8',means)
np.save('WHentropiesNewGrid_8',entrs)
np.save('WHoptfrqsNewGrid_8',optms)
np.save('WHmutinfsNewGrid_8',mutinfs)
np.save('WHwNewGrid_8',W)
np.save('WHpostsNewGrid_8',posts)
