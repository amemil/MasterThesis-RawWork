...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:05 2021
...
np.save('WHestmimatesTau_8',means)
np.save('WHentropiesTau_8',entrs)
np.save('WHoptfrqsTau_8',optms)
np.save('WHmutinfsTau_8',mutinfs)
np.save('WHwTau_8',W)
np.save('WHpostsTau_8',posts)
