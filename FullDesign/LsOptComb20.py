...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 18:05:45 2021
...
np.save('WHestmimatesCombComb_20',means)
np.save('WHentropiesComb_20',entrs)
np.save('WHoptfrqsComb_20',optms)
np.save('WHmutinfsComb_20',mutinfs)
np.save('WHwComb_20',W)
np.save('WHpostsComb_20',posts)
