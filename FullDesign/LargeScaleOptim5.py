...
np.save('WHestmimatesNewGrid_5',means)
np.save('WHentropiesNewGrid_5',entrs)
np.save('WHoptfrqsNewGrid_5',optms)
np.save('WHmutinfsNewGrid_5',mutinfs)
np.save('WHwNewGrid_5',W)
np.save('WHpostsNewGrid_5',posts)
