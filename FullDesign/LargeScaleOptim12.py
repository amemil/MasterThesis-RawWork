...
np.save('WHestmimatesNewGrid_12',means)
np.save('WHentropiesNewGrid_12',entrs)
np.save('WHoptfrqsNewGrid_12',optms)
np.save('WHmutinfsNewGrid_12',mutinfs)
np.save('WHwNewGrid_12',W)
np.save('WHpostsNewGrid_12',posts)
