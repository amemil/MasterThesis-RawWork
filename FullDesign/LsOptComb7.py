...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:31 2021
...
np.save('WHestmimatesComb_7',means)
np.save('WHentropiesComb_7',entrs)
np.save('WHoptfrqsComb_7',optms)
np.save('WHmutinfsComb_7',mutinfs)
np.save('WHwComb_7',W)
np.save('WHpostsComb_7',posts)