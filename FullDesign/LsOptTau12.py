...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:10 2021
...
np.save('WHestmimatesTau_12',means)
np.save('WHentropiesTau_12',entrs)
np.save('WHoptfrqsTau_12',optms)
np.save('WHmutinfsTau_12',mutinfs)
np.save('WHwTau_12',W)
np.save('WHpostsTau_12',posts)