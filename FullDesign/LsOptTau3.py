...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:01:58 2021
...
np.save('WHestmimatesTau_3',means)
np.save('WHentropiesTau_3',entrs)
np.save('WHoptfrqsTau_3',optms)
np.save('WHmutinfsTau_3',mutinfs)
np.save('WHwTau_3',W)
np.save('WHpostsTau_3',posts)
