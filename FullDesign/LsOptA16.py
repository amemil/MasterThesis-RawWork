...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:55:13 2021
...
np.save('WHestmimatesA_16',means)
np.save('WHentropiesA_16',entrs)
np.save('WHoptfrqsA_16',optms)
np.save('WHmutinfsA_16',mutinfs)
np.save('WHwA_16',W)
np.save('WHpostsA_16',posts)