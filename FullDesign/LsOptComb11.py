...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:35 2021
...
np.save('WHestmimatesComb_11',means)
np.save('WHentropiesComb_11',entrs)
np.save('WHoptfrqsComb_11',optms)
np.save('WHmutinfsComb_11',mutinfs)
np.save('WHwComb_11',W)
np.save('WHpostsComb_11',posts)
