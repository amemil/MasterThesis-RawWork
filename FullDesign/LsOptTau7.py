...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:03 2021
...
np.save('WHestmimatesTau_7',means)
np.save('WHentropiesTau_7',entrs)
np.save('WHoptfrqsTau_7',optms)
np.save('WHmutinfsTau_7',mutinfs)
np.save('WHwTau_7',W)
np.save('WHpostsTau_7',posts)