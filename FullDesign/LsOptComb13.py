...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:38 2021
...
np.save('WHestmimatesComb_13',means)
np.save('WHentropiesComb_13',entrs)
np.save('WHoptfrqsComb_13',optms)
np.save('WHmutinfsComb_13',mutinfs)
np.save('WHwComb_13',W)
np.save('WHpostsComb_13',posts)