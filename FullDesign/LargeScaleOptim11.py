...
np.save('WHestmimatesDalesLaw_11',means)
np.save('WHentropiesDalesLaw_11',entrs)
np.save('WHoptfrqsDalesLaw_11',optms)
np.save('WHmutinfsDalesLaw_11',mutinfs)
np.save('WHwDalesLaw_11',W)
np.save('WHpostsDalesLaw_11',posts)
