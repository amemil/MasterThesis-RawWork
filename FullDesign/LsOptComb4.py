...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:28 2021
...
np.save('WHestmimatesComb_4',means)
np.save('WHentropiesComb_4',entrs)
np.save('WHoptfrqsComb_4',optms)
np.save('WHmutinfsComb_4',mutinfs)
np.save('WHwComb_4',W)
np.save('WHpostsComb_4',posts)