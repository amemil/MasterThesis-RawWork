...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:38 2021
...
np.save('WHestmimates_A9',means)
np.save('WHentropies_A9',entrs)
np.save('WHoptfrqs_A9',optms)
np.save('WHmutinfs_A9',mutinfs)
np.save('WHw_A9',W)
np.save('WHposts_A9',posts)
