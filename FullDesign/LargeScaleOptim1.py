...
np.save('WHestmimatesDalesLaw_1',means)
np.save('WHentropiesDalesLaw_1',entrs)
np.save('WHoptfrqsDalesLaw_1',optms)
np.save('WHmutinfsDalesLaw_1',mutinfs)
np.save('WHwDalesLaw_1',W)
np.save('WHpostsDalesLaw_1',posts)
