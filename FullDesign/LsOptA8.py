...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:36 2021
...
np.save('WHestmimates_A8',means)
np.save('WHentropies_A8',entrs)
np.save('WHoptfrqs_A8',optms)
np.save('WHmutinfs_A8',mutinfs)
np.save('WHw_A8',W)
np.save('WHposts_A8',posts)