...
np.save('WHestmimatesDalesLaw_19',means)
np.save('WHentropiesDalesLaw_19',entrs)
np.save('WHoptfrqsDalesLaw_19',optms)
np.save('WHmutinfsDalesLaw_19',mutinfs)
np.save('WHwDalesLaw_19',W)
np.save('WHpostsDalesLaw_19',posts)
