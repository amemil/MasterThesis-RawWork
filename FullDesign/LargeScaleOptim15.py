...
np.save('WHestmimatesNewGrid_15',means)
np.save('WHentropiesNewGrid_15',entrs)
np.save('WHoptfrqsNewGrid_15',optms)
np.save('WHmutinfsNewGrid_15',mutinfs)
np.save('WHwNewGrid_15',W)
np.save('WHpostsNewGrid_15',posts)
