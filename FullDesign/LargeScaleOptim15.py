...
# -*- coding: utf-8 -*-
"""
Created on Wed May  5 16:15:52 2021
...
np.save('WHestmimatesDalesLaw_15',means)
np.save('WHentropiesDalesLaw_15',entrs)
np.save('WHoptfrqsDalesLaw_15',optms)
np.save('WHmutinfsDalesLaw_15',mutinfs)
np.save('WHwDalesLaw_15',W)
np.save('WHpostsDalesLaw_15',posts)
