...
np.save('WHestmimatesDalesLaw_13',means)
np.save('WHentropiesDalesLaw_13',entrs)
np.save('WHoptfrqsDalesLaw_13',optms)
np.save('WHmutinfsDalesLaw_13',mutinfs)
np.save('WHwDalesLaw_13',W)
np.save('WHpostsDalesLaw_13',posts)
