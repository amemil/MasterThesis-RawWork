...
np.save('WHestmimatesDalesLaw_7',means)
np.save('WHentropiesDalesLaw_7',entrs)
np.save('WHoptfrqsDalesLaw_7',optms)
np.save('WHmutinfsDalesLaw_7',mutinfs)
np.save('WHwDalesLaw_7',W)
np.save('WHpostsDalesLaw_7',posts)
