...
np.save('WHestmimatesNewGrid_2',means)
np.save('WHentropiesNewGrid_2',entrs)
np.save('WHoptfrqsNewGrid_2',optms)
np.save('WHmutinfsNewGrid_2',mutinfs)
np.save('WHwNewGrid_2',W)
np.save('WHpostsNewGrid_2',posts)
