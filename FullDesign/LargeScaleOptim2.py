...
# -*- coding: utf-8 -*-
"""
Created on Wed May  5 16:12:30 2021
...
np.save('WHestmimatesDalesLaw_2',means)
np.save('WHentropiesDalesLaw_2',entrs)
np.save('WHoptfrqsDalesLaw_2',optms)
np.save('WHmutinfsDalesLaw_2',mutinfs)
np.save('WHwDalesLaw_2',W)
np.save('WHpostsDalesLaw_2',posts)
