...
np.save('WHestmimatesNewGrid_9',means)
np.save('WHentropiesNewGrid_9',entrs)
np.save('WHoptfrqsNewGrid_9',optms)
np.save('WHmutinfsNewGrid_9',mutinfs)
np.save('WHwNewGrid_9',W)
np.save('WHpostsNewGrid_9',posts)
