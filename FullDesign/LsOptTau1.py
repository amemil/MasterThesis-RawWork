...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:01:56 2021
...
np.save('WHestmimatesTau_1',means)
np.save('WHentropiesTau_1',entrs)
np.save('WHoptfrqsTau_1',optms)
np.save('WHmutinfsATau_1',mutinfs)
np.save('WHwTau_1',W)
np.save('WHpostsTau_1',posts)