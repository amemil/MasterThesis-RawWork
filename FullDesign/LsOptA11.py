...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:41 2021
...
np.save('WHestmimates_A11',means)
np.save('WHentropies_A11',entrs)
np.save('WHoptfrqs_A11',optms)
np.save('WHmutinfs_A11',mutinfs)
np.save('WHw_A11',W)
np.save('WHposts_A11',posts)