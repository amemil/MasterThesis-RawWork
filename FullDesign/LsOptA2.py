...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:41:28 2021
...
np.save('WHestmimates_A2',means)
np.save('WHentropies_A2',entrs)
np.save('WHoptfrqs_A2',optms)
np.save('WHmutinfs_A2',mutinfs)
np.save('WHw_A2',W)
np.save('WHposts_A2',posts)