...
np.save('WHestmimatesTau_20',means)
np.save('WHentropiesTau_20',entrs)
np.save('WHoptfrqsTau_20',optms)
np.save('WHmutinfsTau_20',mutinfs)
np.save('WHwTau_20',W)
np.save('WHpostsTau_20',posts)