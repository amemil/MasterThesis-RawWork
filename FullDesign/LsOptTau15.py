...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 21:10:19 2021
...
np.save('WHestmimatesTau_15',means)
np.save('WHentropiesTau_15',entrs)
np.save('WHoptfrqsTau_15',optms)
np.save('WHmutinfsTau_15',mutinfs)
np.save('WHwTau_15',W)
np.save('WHpostsTau_15',posts)