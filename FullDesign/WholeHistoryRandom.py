...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 19:42:01 2021
...
means,entrs,optms = design.onlineDesign_wh(nofreq =False,constant = False, random = True, optimised = False)

np.save('EstimatesWholeRandom1',means)
np.save('EntropiesWholeRandom1',entrs)
#np.save('OptFrequenciesWholeRandom1',optms)