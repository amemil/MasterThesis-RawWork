...
np.save('WHestmimatesDalesLaw_14',means)
np.save('WHentropiesDalesLaw_14',entrs)
np.save('WHoptfrqsDalesLaw_14',optms)
np.save('WHmutinfsDalesLaw_14',mutinfs)
np.save('WHwDalesLaw_14',W)
np.save('WHpostsDalesLaw_14',posts)
