...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:55:18 2021
...
np.save('WHestmimatesA_20',means)
np.save('WHentropiesA_20',entrs)
np.save('WHoptfrqsA_20',optms)
np.save('WHmutinfsA_20',mutinfs)
np.save('WHwA_20',W)
np.save('WHpostsA_20',posts)