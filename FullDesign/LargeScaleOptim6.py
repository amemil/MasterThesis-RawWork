...
np.save('WHestmimatesDalesLaw_6',means)
np.save('WHentropiesDalesLaw_6',entrs)
np.save('WHoptfrqsDalesLaw_6',optms)
np.save('WHmutinfsDalesLaw_6',mutinfs)
np.save('WHwDalesLaw_6',W)
np.save('WHpostsDalesLaw_6',posts)
