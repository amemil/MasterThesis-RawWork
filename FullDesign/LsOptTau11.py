...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 20:02:09 2021
...
np.save('WHestmimatesTau_11',means)
np.save('WHentropiesTau_11',entrs)
np.save('WHoptfrqsTau_11',optms)
np.save('WHmutinfsTau_11',mutinfs)
np.save('WHwTau_11',W)
np.save('WHpostsTau_11',posts)