...
# -*- coding: utf-8 -*-
"""
Created on Wed May 12 19:55:09 2021
...
np.save('WHestmimatesA_13',means)
np.save('WHentropiesA_13',entrs)
np.save('WHoptfrqsA_13',optms)
np.save('WHmutinfsA_13',mutinfs)
np.save('WHwA_13',W)
np.save('WHpostsA_13',posts)