...
# -*- coding: utf-8 -*-
"""
Created on Wed May  5 16:19:57 2021
...
np.save('WHestmimatesDalesLaw_16',means)
np.save('WHentropiesDalesLaw_16',entrs)
np.save('WHoptfrqsDalesLaw_16',optms)
np.save('WHmutinfsDalesLaw_16',mutinfs)
np.save('WHwDalesLaw_16',W)
np.save('WHpostsDalesLaw_16',posts)
