...
np.save('WHestmimatesNewGrid_16',means)
np.save('WHentropiesNewGrid_16',entrs)
np.save('WHoptfrqsNewGrid_16',optms)
np.save('WHmutinfsNewGrid_16',mutinfs)
np.save('WHwNewGrid_16',W)
np.save('WHpostsNewGrid_16',posts)
