...
np.save('WHestmimatesNewGrid_10',means)
np.save('WHentropiesNewGrid_10',entrs)
np.save('WHoptfrqsNewGrid_10',optms)
np.save('WHmutinfsNewGrid_10',mutinfs)
np.save('WHwNewGrid_10',W)
np.save('WHpostsNewGrid_10',posts)
