...
# -*- coding: utf-8 -*-
"""
Created on Wed May  5 16:15:45 2021
...
np.save('WHestmimatesDalesLaw_10',means)
np.save('WHentropiesDalesLaw_10',entrs)
np.save('WHoptfrqsDalesLaw_10',optms)
np.save('WHmutinfsDalesLaw_10',mutinfs)
np.save('WHwDalesLaw_10',W)
np.save('WHpostsDalesLaw_10',posts)
