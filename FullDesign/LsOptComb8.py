...
# -*- coding: utf-8 -*-
"""
Created on Thu May 13 17:48:32 2021
...
np.save('WHestmimatesComb_8',means)
np.save('WHentropiesComb_8',entrs)
np.save('WHoptfrqsComb_8',optms)
np.save('WHmutinfsComb_8',mutinfs)
np.save('WHwComb_8',W)
np.save('WHpostsComb_8',posts)