...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  8 13:38:18 2021
...
for i in range(4):
    ...
    while (w0est1 < 0.97 or w0est1 > 1.03):
        ...
        inference = ut.ParameterInference(s1,s2,P = 200, Usim = 100, Ualt = 200,it = 1500, infstd=0.0001, N = 1\
    ...
    for j in range(len(datasizes)):
        ...
        inference_sub = ut.ParameterInference(s1_sub,s2_sub,P = 200, Usim = 100, Ualt = 200,it = 1500, infstd=0.0001, N = 1\
...
np.save('TauSamples17to20stim',samples)
#np.save('secondsss',datasizes)
np.save('taudata17to20stim',datasets)