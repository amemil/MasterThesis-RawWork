...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 23:23:11 2021
...
for i in range(4):
    ...
    while (w0est1 < 0.97 or w0est1 > 1.03):
        data = ut.SimulatedData(Ap=0.005, tau=0.02, std=0.0001,b1=-3.1, b2=-3.1, w0=1.0,sec = datasizes[-1], binsize = 1/500.0,freq = 200)
...
np.save('Samples17to20megahighfreq',samples)
#np.save('secondsss',datasizes)
np.save('data17to20megahighfreq',datasets)