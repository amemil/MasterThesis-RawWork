...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 16 17:57:26 2021
...
for i in range(4):
    ...
    while (w0est1 < 0.97 or w0est1 > 1.03):
        data = ut.SimulatedData(Ap=0.005, tau=0.02, std=0.0001,b1=-3.1, b2=-3.1, w0=1.0,sec = datasizes[-1], binsize = 1/500.0,freq = 20)
...
np.save('Samples13to16medfreq',samples)
#np.save('secondsss',datasizes)
np.save('data13to16medfreq',datasets)