...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 10:34:14 2021
...
#ONLY A, 2ms binsize, different datasizes, more input
...
for j in range(len(datasizes)):
    ...
    Aest = inference_sub.standardMH_taufix() 
    sample.append(Aest)
    

np.save('ASampleStimulatedm1.5',sample)