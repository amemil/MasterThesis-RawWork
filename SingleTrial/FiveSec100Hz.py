...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 12:43:23 2021
...
data2 = ut.SimulatedData(Ap=0.005, tau=0.02, std=0.0001,b1=-3.1, b2=-3.1, w0=1.0,sec = 120, binsize = 1/500.0,freq = 100)
...
np.save('weight100hz',W2)
np.save('tensec100hzSample',theta_10ms_freq)
np.save('fivesec100hzSample',theta_5ms_freq)
np.save('onesec100hzSample',theta_1ms_freq)
np.save('pre100hz',s12)
np.save('post100hz',s22)