...
# -*- coding: utf-8 -*-
"""
Created on Tue May 25 17:53:02 2021
...
s1 = np.load('s1Trial5.npy')
s2=np.load('s2Trial5.npy')
W = np.load('WTrial5.npy')

inference = ut.ParameterInference(s1,s2,P = 50, Usim = 100, Ualt = 200,it = 1500, infstd=0.0001, N = 2\
                                        , shapes_prior = np.array([4,5]), rates_prior = np.array([50,100]),sec=20\
