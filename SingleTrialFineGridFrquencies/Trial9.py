...
# -*- coding: utf-8 -*-
"""
Created on Sat May 22 13:20:14 2021
...
s1 = np.load('s1Trial9_2.npy')
s2=np.load('s2Trial9_2.npy')
W = np.load('WTrial9_2.npy')

inference = ut.ParameterInference(s1,s2,P = 50, Usim = 100, Ualt = 200,it = 1500, infstd=0.0001, N = 2\
                                        , shapes_prior = np.array([4,5]), rates_prior = np.array([50,100]),sec=40\
...
np.save('MutinfsTrial9_2',mutinfs)
