...
# -*- coding: utf-8 -*-
"""
Created on Sat May 22 13:20:19 2021
...
s1 = np.load('s1Trial13_2.npy')
s2=np.load('s2Trial13_2.npy')
W = np.load('WTrial13_2.npy')

inference = ut.ParameterInference(s1,s2,P = 50, Usim = 100, Ualt = 200,it = 1500, infstd=0.0001, N = 2\
                                        , shapes_prior = np.array([4,5]), rates_prior = np.array([50,100]),sec=60\
...
np.save('MutinfsTrial13_2',mutinfs)
